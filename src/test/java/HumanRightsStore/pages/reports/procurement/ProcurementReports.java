package HumanRightsStore.pages.reports.procurement;
...
public class ProcurementReports {
    ...
    public ProcurementReports navigateToReport68Page() {
        int maxAttempt = 3;
        for (int attempt = 0; attempt < maxAttempt; attempt++) {
            try {
                driver.get(ConfigUtils.getInstance().getReport68Page());
                Thread.sleep(2500);
                return this;
            } catch (Exception e) {
                driver.navigate().refresh();
                System.out.println("Page refreshed. Retrying navigate to Report68 page url ...");
            }
        }
        throw new RuntimeException("page load Times Out or Publish Issues after " + maxAttempt + " attempts");
    }
    ...
    private final By report25 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report26 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report27 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report28 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report29 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report68 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    ...
    public boolean report68IsDisplayed(){
        int maxAttempts = 3;
        for (int attempt = 0; attempt < maxAttempts; attempt++) {
            try {
                return waitForVisibilityElement(report68).isDisplayed();
            }
            catch (Exception e) {
                System.out.println("retrying open the report ");
                navigateToReport29Page();
        ...
        throw new RuntimeException("failed to open the report68 page check the page manually \n may bepage load Times Out or Publish Issues");
    }

...
public class SystemSettings {
    ...
    private By Email1 = By.xpath("//*[@id=\"MonitoringDeptMail\"]");
    private By Email2 = By.xpath("//*[@id=\"StoresDeptMail\"]");

    public SystemSettings enterEmails() throws InterruptedException{
        WebElement emails1 = waitForVisibilityElement(Email1);
        emails1.sendKeys("test@test.com");
        Thread.sleep(1000);

        WebElement emails2 = waitForVisibilityElement(Email2);
        emails2.sendKeys("test1@test.com");
        Thread.sleep(1000);
        return this ;
    ...
    public boolean classificationsPageIsDisplayed() {
        return
                wait.until(ExpectedConditions.visibilityOfElementLocated(classificationAssertion)).isDisplayed();
    }
    private By pageAssertForItemsCalssEdit = By.xpath("//*[@id=\"content\"]/div[1]/div/div/h6/span");
    public SystemSettings navigateToItemsCalssEdit() throws InterruptedException{
        WebElement parent = wait.until(ExpectedConditions.presenceOfElementLocated(parentMenu));
        List<WebElement>child = parent.findElements(childMenu);
        child.get(10).click();
        Thread.sleep(1000);
    ...
    public boolean isItemsCalssEditDisplayed(){
        return waitForVisibilityElement(pageAssertForItemsCalssEdit).isDisplayed();

...
import HumanRightsStore.pages.procurement.*;
...
public class ContractTest extends TestBase {
    ...
    public Object[][] dataForContract(){
        return new Object[][]{
                {true,"","","","","رئيس الهيئة","دليل الاصناف","11","1"},
                {false,"المستودع العام","11","1","250","رئيس الهيئة","دليل الاصناف","11","1"}

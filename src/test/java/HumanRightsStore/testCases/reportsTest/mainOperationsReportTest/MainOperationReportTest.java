package HumanRightsStore.testCases.reportsTest.mainOperationsReportTest;

import HumanRightsStore.basess.TestBase;
import HumanRightsStore.pages.reports.mainOperations.MainOperationsReports;
...
public class MainOperationReportTest extends TestBase {
    ...
    public void setMainOperationsReports(){
        ...
        mainOperationsReports.navigateToReport50Page()
                .report50IsDisplayed();
        mainOperationsReports.navigateToReport78Page()
                .report78IsDisplayed();
        mainOperationsReports.navigateToReport83Page()
                .report83IsDisplayed();
        mainOperationsReports.navigateToReport87Page()
                .report87IsDisplayed();
        mainOperationsReports.navigateToReport88Page()
                .report88IsDisplayed();

...
import HumanRightsStore.pages.mainOperations.ReturnSpendingOrder;
...
public class ReturnSpendingOrderTest extends TestBase {
    ...
    public Object[][] data (){
        return new Object[][]{
                {"شافعى ابراهيم فهد أحمد","الإدارة العامة للشؤون الإدارية والهندسية والمرافق/وحدة المستودعات","1211","11","1","1"}
        };
    }

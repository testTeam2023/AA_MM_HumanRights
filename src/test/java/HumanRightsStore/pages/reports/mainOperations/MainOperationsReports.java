package HumanRightsStore.pages.reports.mainOperations;
...
public class MainOperationsReports {
    ...
    public MainOperationsReports navigateToReport78Page() {
        int maxAttempt = 3;
        for (int attempt = 0; attempt < maxAttempt; attempt++) {
            try {
                driver.get(ConfigUtils.getInstance().getReport78Page());
                Thread.sleep(2500);
                return this;
            } catch (Exception e) {
                driver.navigate().refresh();
                System.out.println("Page refreshed. Retrying navigate to Report78 page url ...");
            }
        }
        throw new RuntimeException("page load Times Out or Publish Issues after " + maxAttempt + " attempts");
    }
    public MainOperationsReports navigateToReport83Page() {
        int maxAttempt = 3;
        for (int attempt = 0; attempt < maxAttempt; attempt++) {
            try {
                driver.get(ConfigUtils.getInstance().getReport83Page());
                Thread.sleep(2500);
                return this;
            } catch (Exception e) {
                driver.navigate().refresh();
                System.out.println("Page refreshed. Retrying navigate to Report83 page url ...");
            }
        }
        throw new RuntimeException("page load Times Out or Publish Issues after " + maxAttempt + " attempts");
    }
    public MainOperationsReports navigateToReport87Page() {
        int maxAttempt = 3;
        for (int attempt = 0; attempt < maxAttempt; attempt++) {
            try {
                driver.get(ConfigUtils.getInstance().getReport87Page());
                Thread.sleep(2500);
                return this;
            } catch (Exception e) {
                driver.navigate().refresh();
                System.out.println("Page refreshed. Retrying navigate to Report87 page url ...");
            }
        }
        throw new RuntimeException("page load Times Out or Publish Issues after " + maxAttempt + " attempts");
    }
    public MainOperationsReports navigateToReport88Page() {
        int maxAttempt = 3;
        for (int attempt = 0; attempt < maxAttempt; attempt++) {
            try {
                driver.get(ConfigUtils.getInstance().getReport88Page());
                Thread.sleep(2500);
                return this;
            } catch (Exception e) {
                driver.navigate().refresh();
                System.out.println("Page refreshed. Retrying navigate to Report88 page url ...");
            }
        }
        throw new RuntimeException("page load Times Out or Publish Issues after " + maxAttempt + " attempts");
    }
    ...
    private final By report1 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report2 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report3 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report4 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report5 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report6 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report7 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report8 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report9 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report10 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report11 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report12 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report13 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report14 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report15 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report16 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report17 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report18 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report19 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report51 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report39 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report47 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report49 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report50 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;

    private final By report78 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report83 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report87 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    private final By report88 = By.xpath("//*[@id=\"lbl_ReportTitle\"]") ;
    ...
    public boolean report78IsDisplayed(){
        int maxAttempts = 3;
        for (int attempt = 0; attempt < maxAttempts; attempt++) {
            try {
                return waitForVisibilityElement(report78).isDisplayed();
            }
            catch (Exception e) {
                System.out.println("retrying open the report ");
                navigateToReport78Page();

            }
        }
        throw new RuntimeException("failed to open the report 78 page check the page manually \n may bepage load Times Out or Publish Issues");
    }
    public boolean report83IsDisplayed(){
        int maxAttempts = 3;
        for (int attempt = 0; attempt < maxAttempts; attempt++) {
            try {
                return waitForVisibilityElement(report83).isDisplayed();
            }
            catch (Exception e) {
                System.out.println("retrying open the report ");
                navigateToReport83Page();

            }
        }
        throw new RuntimeException("failed to open the report 83 page check the page manually \n may bepage load Times Out or Publish Issues");
    }
    public boolean report87IsDisplayed(){
        int maxAttempts = 3;
        for (int attempt = 0; attempt < maxAttempts; attempt++) {
            try {
                return waitForVisibilityElement(report87).isDisplayed();
            }
            catch (Exception e) {
                System.out.println("retrying open the report ");
                navigateToReport87Page();

            }
        }
        throw new RuntimeException("failed to open the report 87 page check the page manually \n may bepage load Times Out or Publish Issues");
    }
    public boolean report88IsDisplayed(){
        int maxAttempts = 3;
        for (int attempt = 0; attempt < maxAttempts; attempt++) {
            try {
                return waitForVisibilityElement(report88).isDisplayed();
            }
            catch (Exception e) {
                System.out.println("retrying open the report ");
                navigateToReport88Page();

            }
        }
        throw new RuntimeException("failed to open the report 88 page check the page manually \n may bepage load Times Out or Publish Issues");
    }
